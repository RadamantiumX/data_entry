...
export const A_TOKEN_TIME: string =
  process.env.ACCESS_TOKEN_EXPIRATION_TIME ?? '60s'
export const R_TOKEN_TIME: string =
  process.env.REFRESH_TOKEN_EXPIRATION_TIME ?? '1h'
...
export const EXPIRED_MOCK_TOKEN =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._dgSpzwHItTxagoThRdShXN6LfZWVqD9LeYCm6WGFc0'
