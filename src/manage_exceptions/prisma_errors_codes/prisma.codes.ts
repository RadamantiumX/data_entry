export const PRISMA_ERROR_CODES = {
        ...
        P3017: "The migration {migration_name} could not be found. Please make sure that the migration exists, and that you included the whole name of the directory.",
        ...
        P6005: "The user supplied invalid parameters. Currently only relevant for transaction methods. For example, setting a timeout that is too high. https://www.prisma.io/docs/accelerate/connection-pooling#interactive-transactions-query-timeout-limit",
        ...
        P6009: "The global response size limit of Accelerate has been exceeded. https://www.prisma.io/docs/accelerate/connection-pooling#response-size-limit",
        P6010: "Your accelerate project is disabled. Please enable it again to use it.: https://www.prisma.io/docs/accelerate/getting-started#1-enable-accelerate",
        P5011: "This error indicates that the request volume exceeded. Implement a back-off strategy and try again later. For assistance with expected high workloads, contact support.: https://www.prisma.io/docs/platform/support"
    }
