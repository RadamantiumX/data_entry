...
export class ApiKeyQuerys {
  ...
  static async createRecord(
    payload: Omit<ApiKey, 'id' | 'createdAt' | 'updatedAt'>
  ): Promise<void> {
    // Save a new record
  ...
  static async readRecord(
    paramRequest: Pick<ApiKey, 'id'>
  ): Promise<Omit<ApiKey, 'id' | 'createdAt' | 'updatedAt'> | null> {
  ...
  static async updateRecord(
    payload: Omit<ApiKey, 'createdAt' | 'updatedAt'>
  ): Promise<void> {
